...
const LEGACY_FORTUNE_LIBRARY = {
  ...
  tired: [
    ...
    'The wise move today may involve sitting down before the day asks more of you.',
  ...
  grateful: [
    ...
    'Something sweet is settling in more deeply because you paused long enough to receive it.',
  ...
  angry: [
    ...
    'This heat contains useful information. Let wisdom read it before reaction answers.',
  ...
  romantic: [
    ...
    'Something warm may answer you if you are brave enough to be clear.',
  ...
  unknown: [
    ...
    'Fortune favors the person who works gently with the feeling they have.',
...
const TONE_FORTUNES = {
  ...
  restorative: FORTUNE_LIBRARY.stressed,
  reassuring: FORTUNE_LIBRARY.anxious,
  encouraging: FORTUNE_LIBRARY.hopeful,
  energizing: FORTUNE_LIBRARY.hopeful,
  gentle: FORTUNE_LIBRARY.happy,
  guiding: FORTUNE_LIBRARY.confused,
  general: FORTUNE_LIBRARY.mysterious,
};
