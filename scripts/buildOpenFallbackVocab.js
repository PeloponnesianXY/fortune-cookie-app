...
const OUTPUT_PATH = path.join(ROOT_DIR, 'data', 'runtime', 'openFallbackVocab.js');
...
function buildOutputModule(payload) {
  return `// Generated by scripts/buildOpenFallbackVocab.js
...
async function main() {
  ...
  const { BUCKET_VOCAB } = runtimeModule;
