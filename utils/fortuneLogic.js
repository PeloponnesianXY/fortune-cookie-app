...
const EXACT_BUCKET_WORDS = {
  ...
  loving: ['affectionate', 'warmhearted', 'tender', 'compassionate', 'caring', 'sentimental', 'moved', 'touched'],
  romantic: ['romantic', 'passionate', 'enamored'],
  ...
  angry: [
    'angry', 'enraged', 'agitated', 'annoyed', 'irritable', 'aggravated', 'frustrated',
    'exasperated', 'hateful', 'hostile', 'resentful', 'contemptuous',
  ],
  sad: [
  ...
  overwhelmed: ['overwhelmed', 'overloaded', 'swamped', 'buried', 'burnt out', 'burned out'],
...
const ALIAS_BUCKET_WORDS = {
  ...
  loving: ['warm hearted', 'warm heart', 'gentle', 'kind', 'softhearted'],
  romantic: ['flirty', 'smitten', 'in love'],
  ...
  angry: ['mad', 'furious', 'heated', 'pissy', 'snippy', 'salty', 'crabby', 'petulant', 'grouchy'],
  ...
  overwhelmed: ['burn out', 'burned out', 'loaded down', 'too much'],
  numb: ['hollow', 'vacant'],
};
